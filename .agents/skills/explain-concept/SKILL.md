...
0. **Consult the Roadmap**: Before teaching or researching, you **MUST** quickly `view_file` on `CKS_Study_Plan.md` in the root repository to understand where this concept fits into the user's overall CKS curriculum progress.
